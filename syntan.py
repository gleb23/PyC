import copy
from bricks import Int, String, Bool, If, WhileLoop, ReturnExpression, SimpleType, AssignmentOperator, Function, FunctionCall, Block, Expression, BinaryOperator, Sum,  ArrayMetaclass, AbstractArray
from builtins import builtins_map
from errs import UnexpectedIdentifierError, ExpressionError, UnknownIdentifierError, VariableNotInitializedError, IndexOutOfBoundsError, FunctionMustReturnSomethingError, EmptyBracketsAreNotAllowedError, ArrayMustHaveFixedSizeError, IdentifierAlreadyExistsError, NotArrayError, TypeMismatchError, IllegalArrayOperationError, EndOfFileReachedError, SameNameParameterError, WrongParamsFuncCallError, VariableCantBeVoidError, CompileError
